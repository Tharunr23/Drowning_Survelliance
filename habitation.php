      ...
      <header class="site-header" id="masthead">
         <div class="container">
            ...
            <div class="nav-wrapper" id="navsidebar">
               ...
               <!-- main-navigation --></div></div></header><br><br><br><br><br>
               <!--List-->
               <main style="padding-top: 100px;" id="main" class="site-main" itemscope itemtype="http://schema.org/WebPageElement" itemprop="mainEntityOfPage">
        ...
        <img src="images/predator.jpg" class="img-responsive center-block">
        </div>
        <h4>Predators</h4>
        <!--<p><a href="#" class="btn btn-info btn-read">Read More</a></p>-->
         </div>
         <div class="col-md-4">
        <div class="img-hover thumbnail">
        <img src="images/ship.jpg" class="img-responsive center-block">
        </div>
        <h4>Ship</h4>
         </div>
         <div class="col-md-4">
        <div class="img-hover thumbnail">
        <img src="images/habitat.jpg" class="img-responsive center-block">
        </div>
