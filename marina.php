    ...
    <div class="l-loading show show-darkgray">
      ...
      <header class="site-header" id="masthead">
        ...
        <!--<p><a href="#" class="btn btn-info btn-read">Read More</a></p>-->
         ...
         <div class="col-md-4">
        <div class="img-hover thumbnail"><a href="marina.php">
        <img src="images/surv.jpg" class="img-responsive center-block"></a>
        </div>
        <h4>Monitor</h4>
         </div>
         <div class="col-md-4">
        <div class="img-hover thumbnail">
        <img src="images/emergency.jpg" class="img-responsive center-block">
        </div>
        <h4>Emergency</h4>
         </div>
        </div> 
         ...
         <div class="col-md-4">
        <div class="img-hover thumbnail">
        <img src="images/den1.png" class="img-responsive center-block">
        </div>
        ...
        <!--<p><a href="#" class="btn btn-info btn-read">Read More</a></p>-->
         ...
         <div class="col-md-4">
        <div class="img-hover thumbnail">
        <img src="images/rescued.jpg" class="img-responsive center-block">
        </div>
        <h4>Rescued</h4>
         </div>
        </div> 
